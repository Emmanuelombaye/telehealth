...
const products = [
  {
    id: 1, name: "Weight Loss ΓÇö GLP-1 Injection", category: "Weight Loss",
  ...
  {
    id: 2, name: "Weight Loss ΓÇö Oral Daily", category: "Weight Loss",
  ...
  },
  {
    ...
    tagline: "Sildenafil / Tadalafil ΓÇö discreet delivery", price: "$49/mo", priceUSD: 49,
    rating: 4.8, reviews: 5102, badge: "Discreet",
    image: IMG("1631549916768-4119b2e5f926"),
    description: "FDA-approved ED medications prescribed online and shipped in plain packaging within 2ΓÇô3 days.",
    questionnaire: [
      { id: "q1", label: "How long have you experienced ED symptoms?", type: "select", options: ["< 6 months", "6ΓÇô12 months", "1ΓÇô2 years", "2+ years"], required: true },
  ...
  },
  {
    ...
    questionnaire: [
      { id: "q1", label: "Average time to ejaculation?", type: "select", options: ["< 1 min", "1ΓÇô2 min", "2ΓÇô4 min", "4+ min"], required: true },
  ...
  },
  {
    ...
    questionnaire: [
      { id: "q1", label: "How long have you noticed hair thinning?", type: "select", options: ["< 1 year", "1ΓÇô3 years", "3ΓÇô5 years", "5+ years"], required: true },
      { id: "q2", label: "Family history of hair loss?", type: "radio", options: ["Yes ΓÇö Father", "Yes ΓÇö Mother", "Both", "No"], required: true },
  ...
  },
  {
    ...
    tagline: "Doxepin / Trazodone ΓÇö non-habit forming", price: "$59/mo", priceUSD: 59,
    ...
    questionnaire: [
      { id: "q1", label: "How many hours of sleep per night?", type: "select", options: ["< 4", "4ΓÇô6", "6ΓÇô8", "8+"], required: true },
      { id: "q2", label: "Difficulty falling asleep or staying asleep?", type: "radio", options: ["Falling", "Staying", "Both"], required: true },
      { id: "q3", label: "Caffeine intake per day?", type: "select", options: ["None", "1ΓÇô2 cups", "3ΓÇô5 cups", "5+ cups"], required: true },
    ],
    gateways: ["stripe", "paypal", "apple_pay"],
  },
  {
    id: 7, name: "Anxiety Care", category: "Mental Health",
    tagline: "Buspirone / Hydroxyzine ΓÇö same-day Rx", price: "$79/mo", priceUSD: 79,
  ...
  {
    id: 8, name: "Skincare ΓÇö Tretinoin", category: "Skincare",
  ...
  },
  {
    ...
    tagline: "TRT ΓÇö physician-supervised", price: "$249/mo", priceUSD: 249,
...
const gatewayConfig: Record<string, { label: string; icon: string; color: string }> = {
  stripe: { label: "Credit / Debit Card", icon: "≡ƒÆ│", color: "border-violet-400 bg-violet-50 dark:bg-violet-950/30" },
  paypal: { label: "PayPal", icon: "≡ƒà┐∩╕Å", color: "border-violet-400 bg-violet-50 dark:bg-violet-950/30" },
  apple_pay: { label: "Apple Pay", icon: "≡ƒìÄ", color: "border-gray-400 bg-gray-50 dark:bg-gray-950/30" },
  google_pay: { label: "Google Pay", icon: "≡ƒö╡", color: "border-green-400 bg-green-50 dark:bg-green-950/30" },
  klarna: { label: "Klarna ┬╖ Pay in 4", icon: "≡ƒ¢ì∩╕Å", color: "border-pink-300 bg-pink-50 dark:bg-pink-950/30" },
};
...
export function PatientShopPage() {
    ...
    return (
      <div className="max-w-md mx-auto text-center space-y-5 pt-8">
        ...
        <div className="bg-secondary/40 border border-secondary rounded-2xl p-4 text-sm text-secondary-foreground text-left">
          <p className="font-semibold mb-1">ΓÅ▒ What happens next?</p>
          <ol className="space-y-1 text-xs list-decimal list-inside opacity-90">
            <li>A licensed doctor reviews your intake (usually within 2ΓÇô4 hrs)</li>
            <li>If approved, your prescription is sent to our pharmacy</li>
            <li>Medication ships within 1ΓÇô2 business days with tracking</li>
          </ol>
        </div>
        ...
        <Button variant="ghost" className="w-full rounded-xl text-xs" onClick={() => { setStage("catalog"); setSelected(null); }}>
          Continue as guest ΓÇö Back to Shop
        </Button>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-md mx-auto space-y-5">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Secure checkout ΓÇö cancel anytime</p>
        </div>
        <Card>
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      <div className="relative overflow-hidden rounded-3xl p-6 md:p-8" style={{ background: "var(--brand-hero)" }}>
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-4 text-[11px] font-semibold">
            <span className="px-2.5 py-1 rounded-full bg-white/70 text-[var(--brand-lavender-900)]">≡ƒç║≡ƒç╕ HIPAA</span>
            <span className="px-2.5 py-1 rounded-full bg-white/70 text-[var(--brand-lavender-900)]">≡ƒç¬≡ƒç║ GDPR</span>
      ...
      {/* Product grid ΓÇö 2-col cards with images */}
          ...
          <Card key={product.id} className="group hover:shadow-lg hover:-translate-y-0.5 transition-all cursor-pointer overflow-hidden border-border"
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center gap-3 mt-2 text-[10px] text-muted-foreground">
                ...
                <span className="ml-auto">{product.reviews.toLocaleString()} Γ¡É</span>
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <div className="grid grid-cols-3 gap-3 pt-2">
        {[
          ...
          { icon: Clock, label: "Fast Review", sub: "2ΓÇô4 hr doctor review" },
