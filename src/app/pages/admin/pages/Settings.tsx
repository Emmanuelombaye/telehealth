    ...
    <div className="space-y-5 max-w-2xl">
      ...
      <Card>
        ...
        <CardContent className="px-4 pb-4 space-y-3">
          {[{ label: "Platform Name", value: "Peak Health" }, { label: "Support Email", value: "support@peakhealth.com" }, { label: "Default Language", value: "English" }, { label: "Default Timezone", value: "UTC" }].map((f, i) => (
            <div key={i}>
