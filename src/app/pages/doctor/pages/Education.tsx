      ...
      <div className="grid xl:grid-cols-12 gap-10 items-start">
        ...
        <div className="xl:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100 space-y-6">
             ...
             <div className="flex flex-wrap md:flex-nowrap items-center gap-2 overflow-x-auto pb-2 scrollbar-hide snap-x">
                <div className="flex items-center gap-2 pr-4 mr-2 border-r border-slate-100 shrink-0">
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    className={cn(
                      "px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-[0.1em] transition-all whitespace-nowrap snap-start",
