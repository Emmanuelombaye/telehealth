...
import { User, Stethoscope, ShieldCheck, ArrowRight, Activity, Globe, Star, CheckCircle2, Video, Lock, Zap, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-base">Peak Health</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <footer className="border-t border-border py-8 px-4 text-center text-sm text-muted-foreground">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="font-semibold text-foreground">Peak Health</span>
        </div>
        <p>© {new Date().getFullYear()} Peak Health. HIPAA-compliant. Available in {LOCALES.length} languages.</p>
      </footer>
    </div>
  );
}
