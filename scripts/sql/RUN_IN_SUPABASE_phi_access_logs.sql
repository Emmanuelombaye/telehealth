-- Paste full file into Supabase SQL Editor (Dashboard → SQL).
-- Requires public.get_auth_role() and public.get_auth_brand() from prior Peak migrations.

-- (contents match supabase/migrations/20260521120000_phi_access_logs.sql)
...
SELECT to_regclass('public.phi_access_logs') IS NOT NULL AS phi_access_logs_ready;
