-- =============================================================================
-- Super Admin Partner UI — paste into Supabase SQL Editor and Run
-- Enables issue_partner_api_key + revoke_partner_api_key (Brands UI)
-- Requires: get_auth_role(), partner_api_keys table
-- Then redeploy: npx supabase functions deploy partner-api
-- =============================================================================
...
SELECT 'Super Admin Partner UI SQL complete' AS status;
